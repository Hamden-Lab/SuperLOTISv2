...
wt --title "Camera" --tabColor "#00ccff" --suppressApplicationTitle cmd /k "%superlotis% && cd /d %ClientsDir%\sophia && ipython -i -c "%%run sophia_client_new.py" " ^
...
; nt --title "Pfeiffer" --tabColor "#ff0000" --suppressApplicationTitle cmd /k "%superlotis% && cd /d %ClientsDir%\vacuum && ipython -i -c "%%run vacuum_client.py" " ^
...
; nt --title "Chiller" --tabColor "#9900ff" --suppressApplicationTitle cmd /k "%superlotis% && cd /d %ClientsDir%\chiller && ipython -i -c "%%run chiller_client_new.py" " ^
